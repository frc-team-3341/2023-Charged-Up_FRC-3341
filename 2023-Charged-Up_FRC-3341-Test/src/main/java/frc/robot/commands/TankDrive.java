...
public class TankDrive extends CommandBase {
  ...
  @Override
  public void execute() {
    _driveTrain.tankDrive(0.7 * _leftJoystick.getRawAxis(Constants.OperatorConstants.YAxis), // gets y axis from joysticks and moves accordingly 
                          0.7 * _rightJoystick.getRawAxis(Constants.OperatorConstants.YAxis));  
  }
