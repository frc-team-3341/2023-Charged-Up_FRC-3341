...
public class AutoCubeStrip extends SequentialCommandGroup {
  /**
   ...
   */
  public AutoCubeStrip(DriveTrain dt, Arm arm, PoweredIntake poweredIntake) {

    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    poweredIntake.setWristServoPos(0);
    poweredIntake.setClawPos(Constants.Measurements.poweredIntakeCubePinch);
    addCommands(new Rotate(arm, 87), new SpitTap(poweredIntake, 1, 5), new Rotate(arm, 5), new AutoDriveFixed(dt, -3.0, -0.5));
